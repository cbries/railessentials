...
namespace Utilities
{
    ...
    /// 
    /// </summary>
    /// <remarks>https://github.com/khellang/MimeTypes/blob/master/src/MimeTypes/MimeTypes.cs.pp</remarks>
    public class MimeTypesUtilities
    {
        private const string DefaultFallbackMimeType = "application/octet-stream";
        private static string _sFallbackMimeType;

        public static string FallbackMimeType
        {
            get => _sFallbackMimeType;
            set => _sFallbackMimeType = value;
        }

        private static readonly Dictionary<string, string> STypeMap;

        static MimeTypesUtilities()
        {
            _sFallbackMimeType = DefaultFallbackMimeType;

            STypeMap = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
        ...
        public static bool TryGetMimeType(string? fileName, out string? mimeType)
        {
            ...
            {
                return STypeMap.TryGetValue(fileName.Substring(dotIndex + 1), out mimeType);
            }
